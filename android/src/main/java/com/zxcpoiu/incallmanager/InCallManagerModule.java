...
public class InCallManagerModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    public void initialize() {
        ...
        try {
            audioManager = (AudioManager) this.rContext.getSystemService(Context.AUDIO_SERVICE);
    ...
    private float getNormalizedVolume() {
        return audioManager.getStreamVolume(AudioManager.STREAM_MUSIC) * 1.0f / max_volume;
    }
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("android.media.VOLUME_CHANGED_ACTION")) {
                ...
                try {
                    Log.d(TAG, "onKeyDown()");
                    stopRingtone();
                    // InCallManagerModule.stopNativeRingtone();
    ...
    private void _requestPermission(String targetPermission, Promise promise) {
         ...
         * {permission.RECORD_AUDIO}, requestPermissionCode);
         * }
         * });
         * return;
         * }
